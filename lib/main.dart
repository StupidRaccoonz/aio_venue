  ...
  Widget build(BuildContext context) {
    ...
    return ScaledSize(builder: () {
      ...
      if (profile.isLoggedIn.value && !objectbox.loginBox.isEmpty()) {
        ...
        // get all sports list
        final cachedSports = objectbox.sportsBox.getAll();
        if (cachedSports.isNotEmpty) {
          profile.sportsList.assignAll(
              SportsDatamodel.fromJson(cachedSports.last.toJson()).data!.sports);
        }
      ...
      return GetMaterialApp(
        title: 'AIO Sport',
        theme: ThemeData(useMaterial3: true, primaryColor: CustomTheme.appColor, textTheme: CustomTheme.textTheme, appBarTheme: CustomTheme.appBarTheme, scaffoldBackgroundColor: const Color(0xFFF7F9FA)),
        // home: Wrapper(),
